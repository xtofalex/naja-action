...
DESIGN_HOME="$1"
DESIGN_CONFIG="$2"
LIBERTY_FILE="/najaeda-or/flow/objects/nangate45/black_parrot/base/lib/merged.lib"
...
echo "ls /najaeda-or/flow/objects/nangate45/black_parrot"
echo "ls /najaeda-or/flow/objects/nangate45/black_parrot/base/lib"
